        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 p-10">
            <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-xl shadow-lg border">
                ...
                <div className="space-y-4">
                    ...
                    {/* 컬러 */} <div className="bg-pds-gray-200 text-pds-gray-white p-pds-4 rounded-pds-md">bg-pds-gray-200 </div>
                    {/* 컬러 */} <div className="bg-pds-states-dark-100-30 text-pds-gray-white p-pds-4 rounded-pds-md">bg-pds-states-dark-100-30 </div>
