    ...
    return (
        <main className="flex min-h-screen flex-col items-center p-24 gap-4">
            ...
            <div className="space-y-4">
                ...
                {/* 컬러 */} <div className="bg-pds-gray-800 text-pds-gray-white p-pds-4 rounded-pds-md">bg-pds-gray-800 </div>
                {/* 컬러 */} <div className="bg-pds-states-dark-100-50 text-pds-gray-white p-pds-4 rounded-pds-md">bg-pds-states-dark-100-50 </div>
